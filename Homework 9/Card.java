...
public class Card {
	...
	/**
	 * Creates a Joker, with 1 as the associated value. (Note that "new Card()" is
	 * equivalent to "new Card(1,Card.JOKER)".)
	 */
	public Card() {
		suit = JOKER;
		value = 1;
	 ...
	 * 
	 * @return the value, which is one of the numbers 1 through 13, inclusive for a
	 *         regular card, and which can be any value for a Joker.
	 */
	public int getValue() {
		return value;
	}
